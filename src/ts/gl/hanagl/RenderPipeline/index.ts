...
export class RenderPipeline {
	...
	private initInputTextures() {
		...
		loader.load( '../assets/gl/hanagl/smaa/smaa-area.png', ( tex ) => {
		...
		loader.load( '../assets/gl/hanagl/smaa/smaa-search.png', ( tex ) => {
	...
	public render( scene: THREE.Scene, camera: THREE.Camera, renderTarget: THREE.WebGLRenderTarget = null ) {
